        ...
        <div class="container py-5">
            <div class="row justify-content-between">
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="#">Banco Caja Social</a></li>
                        <li><a href="#">Colmena Seguros</a></li>
                        <li><a href="#">Emprender Paz</a></li>
                        <li><a href="#">Deco</a></li>
                        <li><a href="#">Gestora</a></li>
                        <li><a href="#">Ver todas nuestras empresas</a></li>
                    </ul>
                </div>
                <!-- Territorios progreso -->
                <div class="col-6 col-lg-2">
                    <h6>Territorios progreso</h6>
                    <ul class="list-unstyled">
                        @php
                            $cities = App\Models\CityDetail::orderBy('id','DESC')->get(); 
                        @endphp
                        @foreach ($cities as $ct)
                            <li><a href="{{config('app.url')}}/que-hacemos/territorios-progreso/{{$ct->slug}}">{{$ct->name}}</a></li>
                        @endforeach
                    </ul>
                </div>
				...
				<div class="col-6 col-lg-2 social-icons">
                    ...
                    @php
                        $socialLinks = App\Models\SocialLink::orderBy('order','ASC')->get(); 
                    @endphp
                    
                    @if(count($socialLinks)>1)
                        @foreach($socialLinks as $socialLink)
                            <a href="{{$socialLink->website}}" target="_blank" class="m-2"><i class="bi bi-{{$socialLink->class}}"></i> {{$socialLink->class}}</a>
                        @endforeach 	   	
                    @endif
                </div>
            ...
            <div class="footer-bottom">
                ...
                <p class="ms-3 d-inline">© {{ date('Y') }} - Fundación Grupo Social | Todos los derechos reservados | Dirección: Calle 72 N° 10 – 71 | Teléfono: (571) – 5953810 ext 15979 | Bogotá, Colombia</p>
            </div>
        </div>
    </footer>
