<section class="bg_light_blue">
    ...
    <div class="container position-relative">
            <div class="row mt-5 p-2 p-md-4">
                <div class="col-12 col-lg-12 mt-4">
                    <h2 class="text-deepblue colored_lines position-relative pb-3 mb-5 we_700">¿Qué hacemos?</h2>
                </div>
                <div class="col-12 col-lg-12 p-2 p-md-2">
                    <p class="text-deepblue">Trabajamos por una sociedad basada en la solidaridad, el bien común y los valores trascendentes, especialmente para aquellos que siempre han encontrado las puertas cerradas.<br>Lo hacemos de dos formas:</p>
                </div>
            </div>    
    </div>

    <div class="container mb-5 p-4 pb-md-5">
