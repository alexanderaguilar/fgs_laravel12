<section class="position-relative overview-hidden how_module">
	<div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-12 col-lg-6 p-5" data-aos="fade-right">
                
                <h2 class="position-relative mb-5 py-5 titleHowWeDo">¿Cómo actuamos?</h2>
                <p>En Fundación Grupo Social buscamos la transformación real de la sociedad colombiana basados en la solidaridad, la ética, los valores trascendentes, el bien común y el desarrollo de los sectores marginados.</p>
                <p>Nos proponemos ser testimonio de una forma diferente de actuación, a través de nuestras empresas y del acompañamiento que realizamos en las comunidades más necesitadas.</p>
            		
            </div>
            <div class="col-lg-6 p-0 position-relative" data-aos="fade-left" data-aos-delay="300">
