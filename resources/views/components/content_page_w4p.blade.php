...
<section id="content">
    ...
    <section class="mt-5">
        <div class="container-fluid">
            <div class="row">
                <div class="col p-0"><img class="d-none d-sm-block img-fluid" src="/storage/w4p/w4p_main_cover_desktop.jpg"
                        alt="Banner Work4Progress 2025 Desktop" width="100%"> <img class="d-block d-sm-none img-fluid"
                        src="/storage/w4p/w4p_main_cover_mobile.jpg" alt="Banner Work4Progress 2025 Mobile"
                        width="100%"></div>
            </div>
        </div>
    </section>
    <!-- Call Status and Intro -->
    ...
    <section class="py-5 section-bg">
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-10">
                    <h2 class="oswaldfonts mb-5">Fechas Clave</h2>
                </div>
            </div>
            <div class="row justify-content-center text-center">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="alert alert-info h-100 p-4">
                        ...
                        <p class="mb-0 fs-5">22 de Septiembre</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="alert alert-info h-100 p-4">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="alert alert-info h-100 p-4">
                        <h5 class="oswaldfonts" style="font-weight: normal;">Talleres en Regiones</h5>
                        <p class="mb-0 fs-5">
                            Taller presencial en Apartadó<br>
                            <sub>Miércoles 1 de octubre de 2025<br>
                                Hora: 10:00 a.m.<br>
                                Cra. 106 C Nº 101B - 02, Barrio Los Pinos</sub><br><br>
                            <?php //Taller presencial en Medellín<br><sub>Jueves 2 de octubre de 2025<br>Hora: 10:00 a.m.</sub><br><br> ?>
                            Taller presencial en Cartagena<br>
                            <sub>Viernes 3 de octubre de 2025<br>
                                Hora: 10:00 a.m.<br>
                                Transversal 74 No. 31c-39, Piso 2, Barrio Los Alpes – Sede Fundación Grupo Social
                            </sub>
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="alert alert-danger h-100 p-4">
                        <h5 class="oswaldfonts" style="font-weight: normal;">Cierre</h5>
                        <p class="mb-0 fs-5">31 de Octubre</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="my-3">
        <div class="container">
            <div class="row">
                <div class="col p-0">
                    <a href="https://www.linkedin.com/events/7376353559216562176/" target="_blank" rel="noopener">
                        <img class="d-none d-sm-block img-fluid" src="/storage/w4p/w4p_2025_linkedin_d.jpg" alt="Banner Work4Progress 2025 Linkedin" width="100%"> 
                        <img class="d-block d-sm-none img-fluid" src="/storage/w4p/w4p_2025_linkedin_m.jpg" alt="Banner Work4Progress 2025 Linkedin" width="100%">
                    </a>
                </div>
            </div>
        </div>
    ...
    <section class="" style="background-image: url('/storage/w4p/w4p_bg_transp.png'); background-size: contain;">
        <div class="container">
                            ...
                            <ul class="list-unstyled mt-4">
                                ...
                                <li class="mb-3 d-flex"><span class="me-3 fs-4">✓</span>
                                    <div><strong>Disponer de capacidad y estructura:</strong> Suficientes para
                                        garantizar los objetivos del programa.</div>
                                </li>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row text-center">
                <div class="col-12">
                    <h2 class="oswaldfonts mb-5">Pasos para Participar</h2>
                </div>
            </div>
    ...
    <!-- Documents of Interest Section -->
    <section class="py-5 section-bg"
        style="background-image: url('/storage/w4p/w4p_bg_transp_2.png'); background-size: cover; background-position: top center;">
        <div class="container">
            <div class="row text-center">
                <div class="col-12">
                ...
                <div class="col-md-6 col-lg-3 mb-3"><a class="btn btn-outline-primary p-3 w-100"
                        href="/storage/w4p/DOC_01_bases_convocatoria_2025.pdf" target="_blank"
                ...
                <div class="col-md-6 col-lg-3 mb-3"><a class="btn btn-outline-primary p-3 w-100"
                        href="/storage/w4p/DOC_04_preguntas_frecuentes.pdf" target="_blank"
                ...
                <!-- NEW BUTTONS-->
                 <div class="col-md-6 col-lg-3 mb-3"><a class="btn btn-outline-primary p-3 w-100"
                        href="/storage/w4p/DOC_08_presupuesto_global.xlsx" target="_blank"
                        rel="noopener noreferrer">Presupuesto Global W4P</a></div>
                <div class="col-md-6 col-lg-3 mb-3"><a class="btn btn-outline-primary p-3 w-100"
                        href="/storage/w4p/DOC_09_cartera_prototipos.xlsx" target="_blank"
                        rel="noopener noreferrer">Presupuesto Detallado W4P</a></div>
            </div>
        </div>
    </section>
</section>
